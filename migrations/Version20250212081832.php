 ...
 */
final class Version20250212081832 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, patient_id_id INT NOT NULL, docteur_id_id INT NOT NULL, date_consultation DATE NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_964685A6EA724598 (patient_id_id), INDEX IDX_964685A66061999D (docteur_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dossiers_medicaux (id INT AUTO_INCREMENT NOT NULL, patient_id_id INT DEFAULT NULL, docteur_id_id INT DEFAULT NULL, date_création DATE NOT NULL, diagnostic VARCHAR(255) NOT NULL, traitement VARCHAR(255) NOT NULL, fichier VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_29FDDE35EA724598 (patient_id_id), UNIQUE INDEX UNIQ_29FDDE356061999D (docteur_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
