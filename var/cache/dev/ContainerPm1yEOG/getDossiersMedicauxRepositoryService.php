 ...
 */
class getDossiersMedicauxRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DossiersMedicauxRepository' shared autowired service.
     *
     * @return \App\Repository\DossiersMedicauxRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DossiersMedicauxRepository.php';

        return $container->privates['App\\Repository\\DossiersMedicauxRepository'] = new \App\Repository\DossiersMedicauxRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
