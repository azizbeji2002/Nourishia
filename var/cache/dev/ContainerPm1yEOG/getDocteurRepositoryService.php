 ...
 */
class getDocteurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DocteurRepository' shared autowired service.
     *
     * @return \App\Repository\DocteurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DocteurRepository.php';

        return $container->privates['App\\Repository\\DocteurRepository'] = new \App\Repository\DocteurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
